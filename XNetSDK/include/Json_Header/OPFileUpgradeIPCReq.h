...
#define JK_OPFileUpgradeIPCReq "OPFileUpgradeIPCReq"
class OPFileUpgradeIPCReq : public JObject 
{
public:
...
public:
	OPFileUpgradeIPCReq(JObject *pParent = NULL, const char *szName = JK_OPFileUpgradeIPCReq):
	...
	VideoOutChannel(this, "VideoOutChannel"){
		this->Parse("{ \"Name\" : \"OPFileUpgradeIPCReq\", \"Ret\" : 100, \"SessionID\" : \"0x2c\", \"OPFileUpgradeIPCReq\" : { \"AlarmInChannel\" : 2," "\"AlarmOutChannel\" : 1, \"AudioInChannel\" : 1, \"BuildTime\" : \"2017-04-12 19:13:16\", \"CombineSwitch\" : 0," "\"DeviceRunTime\" : \"0x00001D66\", \"DigChannel\" : 0, \"EncryptVersion\" : \"Unknown\", \"ExtraChannel\" : 0, \"HardWare\" :" "\"HI3518E_53H13_S39\", \"HardWareVersion\" : \"Unknown\", \"SerialNo\" : \"558aa5ddab9c31cb\", \"SoftWareVersion\" :" "\"V4.02.R12.D4806531.10002.142100.00000\", \"TalkInChannel\" : 1, \"TalkOutChannel\" : 1, \"UpdataTime\" : \"\", \"UpdataType\" :" "\"0x00000000\", \"VideoInChannel\" : 1, \"VideoOutChannel\" : 1, \"DeviceType\" : 0 } }");
	};

	~OPFileUpgradeIPCReq(void){};
};
